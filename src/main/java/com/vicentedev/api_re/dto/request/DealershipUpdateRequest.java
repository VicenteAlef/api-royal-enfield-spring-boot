...
@Schema(description = "Dados para atualização de uma concessionária")
public record DealershipUpdateRequest(
        @Schema(description = "Nome da concessionária", example = "Royal Enfield Moema Premium")
        ...
        @Schema(description = "Telefone de contato", example = "(11) 5051-9999")
        @Size(max = 20, message = "Phone must not exceed 20 characters")
        String phone,

        @Schema(description = "E-mail de contato da loja", example = "contato.moema@royalenfield.com.br")
